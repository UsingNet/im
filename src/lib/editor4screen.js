...
define(['lib/html2canvas'], function(html2canvas){
    ...
    if(require.version){
        nav.style.backgroundImage = 'url('+location.protocol+'//im.dev.usingnet.com/src/v2/image/cuttoolbar.png)';
    }else{
        nav.style.backgroundImage = 'url('+location.protocol+'//im.dev.usingnet.com/build/v2/image/cuttoolbar.png)';
    }
